...
require_once 'cxxxx/HomeController.php';
require_once 'models/Uusario.php';
...
class HistorialVentaController
{
	...
	public function funcion2()
	{
		...
		$desgloseHoraCoach = $this->desgloseUsuarios($usuarios, $fecha_i, $fecha_f);
	...
	public function generarExcel(){
		...
		$fecha_f = $_POST['date2'];
		$ventas = new Bitacora();
		$ventaUsuario = $ventas->getVentasCoach($fecha_i, $fecha_f);
		$reporteUsuario = HomeController::getDesgloseCoaches($ventaUsuario, $fecha_i, $fecha_f);
		...
		foreach ($reporteUsuario as $indice => $reporte) {
			//var_dump($indice); 
